...
_model = load_model('pyTest_model_gray_0329_suffle_liss4.h5')
...
class App(QDialog):
    ...
    def createCtrlLayout(self):
        ...
        layout.addWidget(self.button_done, 0,3)
        layout.addWidget(self.button_learning, 0,4)
        ...
        layout.addLayout(layout2, 1,0, 1, 4)
    ...
    def getfiles(self) :
        self.parent_foldername = QFileDialog.getExistingDirectory(self, 'Select directory')
        print(self.parent_foldername)
        self.low_folder_list = os.listdir(self.parent_foldername)
        print(self.low_folder_list)
        self.Idx_folder_list = 0

        for i in self.low_folder_list :
            ImgProc.makedirectory('D:/SVN/vis_research/deepStyleVolumeRendering/imgs/test/predict_VRdata/'+ i)

        self.foldername = self.parent_foldername + '/' + self.low_folder_list[self.Idx_folder_list]
        print(self.foldername)
        self.file_list = os.listdir(self.foldername)
        print(self.low_folder_list[self.Idx_folder_list])
        print(self.foldername)
        self.file_list.sort()
    ...
    def doneButton(self) :
        print("predict img : " + self.file_list[self.fileIdx])
        nFilename = self.file_list[self.fileIdx].split('.')
        print("save at :" + 'D:/SVN/vis_research/deepStyleVolumeRendering/imgs/test/predict_VRdata/' + self.low_folder_list[self.Idx_folder_list] +'/')

        self.refresh_GridSize(32)
        self._image.save('D:/SVN/vis_research/deepStyleVolumeRendering/imgs/test/predict_VRdata/' + self.low_folder_list[self.Idx_folder_list] +'/'+ nFilename[0]+'_32.png',"PNG")
        self.refresh_GridSize(64)
        self._image.save('D:/SVN/vis_research/deepStyleVolumeRendering/imgs/test/predict_VRdata/' + self.low_folder_list[self.Idx_folder_list] +'/'+ nFilename[0]+'_64.png',"PNG")
        self.refresh_GridSize(128)
        self._image.save('D:/SVN/vis_research/deepStyleVolumeRendering/imgs/test/predict_VRdata/' + self.low_folder_list[self.Idx_folder_list] +'/'+ nFilename[0]+'_128.png',"PNG")
        self.refresh_GridSize(256)
        self._image.save('D:/SVN/vis_research/deepStyleVolumeRendering/imgs/test/predict_VRdata/' + self.low_folder_list[self.Idx_folder_list] +'/'+ nFilename[0]+'_256.png',"PNG")
        self.refresh_GridSize(512)
        self._image.save('D:/SVN/vis_research/deepStyleVolumeRendering/imgs/test/predict_VRdata/' + self.low_folder_list[self.Idx_folder_list] +'/'+ nFilename[0]+'_512.png',"PNG")
    ...
    def ImageDeSelection(self,event):
        ...
        for i in idx :
            self.subImages.removeSelectedIdx(i)
