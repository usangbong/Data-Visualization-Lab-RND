...
# =============================================================================
    decoder = RepeatVector(ac_weights.shape[0])(ac_encoder_h1)
    ac_decoder = LSTM(args['l_size'],
                    kernel_initializer='glorot_uniform',
                    return_sequences=False,
                    return_state=False,
                    dropout=0.2,
                    implementation=args['imp'])(decoder, initial_state=[ac_encoder_h1, ac_encoder_c])
...
# =============================================================================
    ...
    model.summary()
    plot_model(model, to_file='shared_cat.png', show_shapes=True, show_layer_names=True)
