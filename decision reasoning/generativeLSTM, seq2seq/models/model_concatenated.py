...
# =============================================================================
    ...
    if args['lstm_act'] is not None:
        encoder_h1, encoder_h2, encoder_c = LSTM(args['l_size'],
...
# =============================================================================
    encoder_h1 = BatchNormalization()(encoder_h1)
    encoder_c = BatchNormalization()(encoder_c)
    
# =============================================================================
# The layer specialized in prediction
# =============================================================================
    decoder = RepeatVector(ac_weights.shape[0])(encoder_h1)
    ac_decoder = LSTM(args['l_size'],
                    kernel_initializer='glorot_uniform',
                    return_sequences=False,
                    return_state=False,
                    dropout=0.2,
                    implementation=args['imp'])(decoder, initial_state=[encoder_h1, encoder_c])
...
# =============================================================================
    ...
    model.summary()
    plot_model(model, to_file='model_cat.png', show_shapes=True, show_layer_names=True)
