...
namespace RenderHeads.Media.AVProMovieCapture
{
	public class Utils
	{
		...
		public static string[] ImageSequenceFormatNames = new string[] { "PNG (uncompressed)" };
#elif UNITY_EDITOR_OSX || UNITY_STANDALONE_OSX
		public static string[] ImageSequenceFormatNames = new string[] { "PNG", "JPEG", "TIFF", "HEIF" };
#else
		public static string[] ImageSequenceFormatNames = new string[] {};
#endif
