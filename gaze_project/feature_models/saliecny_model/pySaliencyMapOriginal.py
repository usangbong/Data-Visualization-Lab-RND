...
import cv2
import numpy as np
import pySaliencyMapDefsOriginal

class pySaliencyMapOriginal:
    # initialization
    def __init__(self, width, height):
        ...
        self.SM = None
        self.GaborKernel0   = np.array(pySaliencyMapDefsOriginal.GaborKernel_0)
        self.GaborKernel45  = np.array(pySaliencyMapDefsOriginal.GaborKernel_45)
        self.GaborKernel90  = np.array(pySaliencyMapDefsOriginal.GaborKernel_90)
        self.GaborKernel135 = np.array(pySaliencyMapDefsOriginal.GaborKernel_135)
    ...
    def MFMGetFM(self, src):
        ...
        if self.prev_frame is not None:
            farne_pyr_scale= pySaliencyMapDefsOriginal.farne_pyr_scale
            farne_levels = pySaliencyMapDefsOriginal.farne_levels
            farne_winsize = pySaliencyMapDefsOriginal.farne_winsize
            farne_iterations = pySaliencyMapDefsOriginal.farne_iterations
            farne_poly_n = pySaliencyMapDefsOriginal.farne_poly_n
            farne_poly_sigma = pySaliencyMapDefsOriginal.farne_poly_sigma
            farne_flags = pySaliencyMapDefsOriginal.farne_flags
    ...
    def SMAvgLocalMax(self, src):
        # size
        stepsize = pySaliencyMapDefsOriginal.default_step_local
        width = src.shape[1]
        height = src.shape[0]
        # find local maxima
        numlocal = 0
...
#            sys.exit("size mismatch")
        ...
        wi = pySaliencyMapDefsOriginal.weight_intensity
        wc = pySaliencyMapDefsOriginal.weight_color
        wo = pySaliencyMapDefsOriginal.weight_orientation
        wm = pySaliencyMapDefsOriginal.weight_motion
