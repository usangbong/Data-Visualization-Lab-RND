...
# OUTDIR = "../output/vis_sti_feature/HOG/"
# create_dir(OUTDIR)
...
#             fd, hog_image = hog(img, orientations=9, pixels_per_cell=(8, 8),cells_per_block=(2, 2), visualize=True, multichannel=multichannelFlag)
#             csvPath = OUTDIR + dirname +"/"
#             create_dir(csvPath)
#             csvPath = csvPath + _stiName.split('.')[0]+".csv"
#             csvWriter(csvPath, hog_image)
#     else:
