...
function RadarChart(props) {
  ...
  // const colores_g = ["#525252", "#e41a1c", "#377eb8"];
  ...
  useEffect(() => {
    ...
    for(let k=0; k<radarData.length; k++){
      ...
      for(let i=0; i<features.length; i++){
        ...
        // _data[features[i]] = [boxPlotData[i].quartile[0], boxPlotData[i].quartile[1], boxPlotData[i].quartile[2]]
      }
    ...
    //     fillColor = "none";
    //   }else{
    //     fillColor = colores_g[parseInt(i/3)];
    //   }
