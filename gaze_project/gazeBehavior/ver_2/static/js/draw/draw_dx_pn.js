function draw_dx_pn_chart(gpoints){
	console.log("draw_dx_pn_chart");

	var margin = {top: 20, right: 20, bottom: 50, left: 70};
	var width = 512 - margin.left - margin.right;
	...
	var dataset = [];
	var prev = 0;
	for(var i=0; i<gpoints.x.length; i++){
		var cur = gpoints.x[i];
		if(i==0){
			prev = cur;
			continue;
