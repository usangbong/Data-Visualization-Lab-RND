...
using ViveSR.anipal.Eye;
    ...
    public class EyeFocusVis : MonoBehaviour
    {
        private Renderer Renderer;
        public uint BendCount = 3, PieCount = 8, FrameWidth = 1;
        ...
        public void Focus(Vector3 focusPoint)//초점
        {
            ...
            Vector3 axis = (focusPoint - transform.position) / Vector3.Distance(focusPoint, transform.position); //방향 벡터
