    ...
    public class SRanipal_EyeFocusSample_v2 : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            foreach (GazeIndex index in GazePriority)
            {
                ...
                //
                int menu_layer_id = LayerMask.NameToLayer("Menu");
                //
                bool eye_focus;
                bool menu_focus;
                ...
                /*
                if (eye_callback_registered)
                    menu_focus = SRanipal_Eye_v2.Focus(index, out GazeRay, out FocusInfo, 0, MaxDistance, (1 << menu_layer_id), eyeData);
                else
                    menu_focus = SRanipal_Eye_v2.Focus(index, out GazeRay, out FocusInfo, 0, MaxDistance, (1 << menu_layer_id));
                */
