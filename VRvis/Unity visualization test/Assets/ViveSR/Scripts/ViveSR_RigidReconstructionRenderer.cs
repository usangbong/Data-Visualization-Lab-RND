...
namespace Vive.Plugin.SR
{
    public class ViveSR_RigidReconstructionRenderer : ViveSR_Module
    {
        ...
        [ReadOnly] public int ModelChunkIdx;
        [ReadOnly] public int ModelChunkNum;
        ...
        {
            if (!ViveSR.Instance.EnableRigidReconstructionModule)
            {
                return false;
            }
        ...
        private void SetMeshData(int id)
        {
            ...
            bool topologyIsTrangle = (LiveMeshDisplayMode == ReconstructionDisplayMode.ADAPTIVE_MESH && (IndexNum > 0) || renderMode == ReconstructionRenderMode.MODEL_PREVIEW);
        ...
        {
            return (ModelChunkIdx == ModelChunkNum - 1) || (ModelChunkNum == 0); // normal or abnormal finish in SRWorks
        }
