...
public class MakeLeftLaser : MonoBehaviour
{
    ...
    void UpdateLaser()
    {
        start = leftEye.transform.position;
        last = rayTest.Llast;
    ...
    {
        string path = "./Assets/Resources/Test/" + "laserLeftEye" + System.DateTime.Now.ToString("yyyy-MM-dd-HH-mm-ss") + " testPos.txt";

        SavePosition(path, moveDataList);

        Debug.Log("Save Left Finish");
